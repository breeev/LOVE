...
from tkinter import Tk as Window,Button,Entry,Frame,Label,LabelFrame,OptionMenu,StringVar,Text,Scrollbar,Canvas
...
def fontshowcase(e=None):
    ...
    root.mainloop()
def settings(e=None):
    global x,y,s,family,size,bgc,fgc,pside,relief,bd,f1,f2,f3,f4,f5,f6,f7,f8,c,o,q,butt,link,src,exp
    s=Window()
    s.bind('<Control-q>',ex)
...
def Apply():
    global x,y,s,family,size,bgc,fgc,side,relief,bd,f1,f2,f3,f4,f5,f6,f7,f8,c,o,q,butt,chars,Family,Size,bgC,fgC,Side,Relief,Bd,link
    frames=[f1,side,status]
    labelframes=[c]
    labels=[f2,f3,f4,f5,f6,f7,f8,clock]
    entries=[family,size,bgc,fgc,bd]
